...
class Chatbot():
    ...
    def show_response(self , res):
        issues_response = res.choices[0].message.parsed.markdown_answer
...
bot.add_message("system",res.choices[0].message.parsed.markdown_answer)
