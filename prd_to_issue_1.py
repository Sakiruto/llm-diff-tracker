...
"""
Will creating multiple integration for every user , I think the answer is no 
so when to use code based integration generations ??
how many users can a integrations handle ??
...
#         "scopes": ["read:me", "read:jira-user", "read:jira-work"]
#     },   
# )
...
toolset.add_auth(
    ...
    parameters=[
        dict(
            name="Authorization",
            in_="header",
            value=f"Bearer {data.get("access_token")}",
        )
    ],
)
